...
public class DanielsUserTest {
    ...
    public void setUp() throws Exception {
        theUser = new User(1, "testUser", "testPass", "testemail@email.com");
    }
    ...
    public void TestGetAccounts() {
        ...
        accountList.add(one);
        accountList.add(two);
        theUser = new User(1, "test", "test", "email@email.com", accountList);
    ...
    public void TestGetAccount() {
        ...
        accountList.add(one);
        accountList.add(two);
        theUser = new User(1, "test", "test", "myemail@emails.com", accountList);
