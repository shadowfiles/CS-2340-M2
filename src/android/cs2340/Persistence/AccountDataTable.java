 ...
 *
 */
public class AccountDataTable extends AbstractDataTableFactory implements AccountDataSource {
    /**
     ...
     */
    private static TransactionDataTable transactionDataTable;

    /**
     * Constructor for the data source.
     * @param c The Android Context the data source is created in.
     */
    public AccountDataTable(Context c) {
        super(c);
        if (transactionDataTable == null) {
            transactionDataTable = new TransactionDataTable(c);
        }
    }
